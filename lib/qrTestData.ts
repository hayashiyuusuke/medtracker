...
import { SimpleJahisParser } from './qrParser';
...
東京総合病院`,
  ...
  // 実際のカンマ区切り形式のQRコードデータ（お薬手帳）
  "32971101830,1 301,1,1 日 1 回(朝食) 2 錠毎,1,調剤,5,1,,1 201,2,ベタメタゾンリン酸塩錠10mg「タナベ」,2,錠,4,4980022F2042,1 301,2,,(朝 タ)食後,30,日分,1,1,,1 201,3,エピナスチン塩酸塩点眼液0.05%「日点」,10,mL,4,1319762Q1117,1 301,3,,両眼に1日4回「朝」,1,調剤,,5,1,,1",
];
...
export class QRTestHelper {
  ...
  /**
   * 実際のカンマ区切り形式QRコードデータを取得（お薬手帳）
   */
  static getCommaDelimitedData(): string {
    return testJAHISData[7];
  }
